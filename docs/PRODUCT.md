# Product Brief: GitHub Authentication
...
Tool integrations can create accidental side effects when authentication, scope, preview, execution, and verification are not separated. The result is often difficult to reproduce, audit, or hand to another person.
...
A preview and explicit approval are required before consequential writes or external actions. Credentials, personal records, private endpoints, and original AI-OS infrastructure are outside the public package.
