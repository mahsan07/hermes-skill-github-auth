...
Github Auth is a focused, shareable agent workflow.

## What it does

Set up GitHub authentication using HTTPS tokens, SSH keys, or gh CLI login without exposing credentials. Use when the user explicitly requests this capability or a closely related task.
